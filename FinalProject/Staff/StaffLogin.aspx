<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StaffLogin.aspx.cs" Inherits="FinalProject.Staff.StaffLogin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <center><h2><asp:Label ID="Label1" runat="server" Text="StaffLoginPAGE"></asp:Label></h2><br>
